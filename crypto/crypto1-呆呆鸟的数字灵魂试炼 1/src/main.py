...
if __name__ == "__main__":
    ...
    #print("Silly Bird:I will show you 10 numbers one by one.")
    #print("For each number, you need to calculate φ(n) and enter your answer.")
    #print("If you get any answer wrong, the program will exit immediately.\n")
    #print("(Generating the questions, please wait a moment.)\n")
